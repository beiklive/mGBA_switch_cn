...
struct mGUIRunner {
	...
	void (*drawBKImage)(struct mGUIRunner*, const color_t* pixels, unsigned width, unsigned height, bool faded, int targetX, int targetY, int targetWidth, int targetHeight, bool isSame);
